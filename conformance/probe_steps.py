...
``passed``/``detail`` to ``conformance/corpus/steps.expected.json``. The Rust half
...
Usage::
    ...
    python3 conformance/probe_steps.py > conformance/corpus/steps.expected.json
...
dependent — see `spec/002-builtin-steps/spec.md` FR-004, FR-008 and FR-016.
...
def main() -> int:
    ...
    document = {
        "_comment": (
            "Generated by conformance/probe_steps.py against the Python implementation. "
