...
- cast: `examples/artifacts/pi-workflow-model-context/session.cast`
- screenshot: `examples/artifacts/pi-workflow-model-context/final.svg`
- screen_text: `examples/artifacts/pi-workflow-model-context/final.txt`
- exit_code_file: `examples/artifacts/pi-workflow-model-context/session.exitcode`
- step_screenshots: `examples/artifacts/pi-workflow-model-context/steps`
- video: `examples/artifacts/pi-workflow-model-context/session.mp4`
